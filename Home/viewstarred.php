...
$query = "SELECT * FROM mails where Id='$idofmail' AND starred = 1";
...
<link href="css/viewstar.css" rel="stylesheet" type="text/css" media="all"/>
...
<body style="background:#394264;">
  ...
  <div class="top_menu_list">
    ...
    <ul class="hor_menu">
      ...
      <li class="menu_bar"><input  type="button" onClick="document.location.href='unstar.php'" class="menu_buttons" id="star_mail"/></li>
      <li class="menu_bar"><input  type="button" class="menu_buttons" id="report_spam"/></li>
      <li class="menu_bar"><input  type="button" onClick="document.location.href='deletemail.php'" class="menu_buttons" id="delete_mail"/></li>
    </ul>
    </div>
  </div>
