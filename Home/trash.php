...
<link href="css/trash.css" rel="stylesheet" type="text/css" media="all"/>
...
<body style="background:#394264;">
  ...
  <div class="top_menu_list">
    ...
    <!--  <li class="menu_bar"><input  type="button" class="menu_buttons" id="report_spam"/></li> -->
      <li class="menu_bar"><input  type="button" onClick="document.location.href='untrash.php'" class="menu_buttons" id="delete_mail"/></li>
    </ul>
    </div>
  </div>
